...
const char* TOPIC_WINDSPEEDSENSOR = "wx/windspeedsensor"; 	// topic to check if the RS485 dialog is OK
const char* TOPIC_WINDDIRSENSOR   = "wx/winddirsensor"; 	   // topic to check if the RS485 dialog is OK
