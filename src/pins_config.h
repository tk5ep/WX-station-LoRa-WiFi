...
#elif defined(TTGO_T_Beam_V1_0_SX1268)
#define GPS_RX_PIN                  34
#define GPS_TX_PIN                  12
#define BUTTON_PIN                  38
#define BUTTON_PIN_MASK             GPIO_SEL_38
...
#else
#error "For the first use, please define the board version and model in <utils. h>"
#endif