...
***************************************************/
// temperature/humidity/pressure sensors choice.
// ONLY ONE must be chosed, comment out all the others
#define WITH_BME280
//#define WITH_SHT31

// comment out the sensors which are not present
...
const char* WG_ID          = "ID";                         // Your WunderGround ID. You need to register to get this ID and Key
const char* WG_PWD         = "PWD";                          // Your WunderGround key
...
const char* mqtt_broker       = "mqqt.server.address";		// the MQTT server
...
//const char *APRS_IS_SERVER     = "your.aprs.server"; // APRS server address
