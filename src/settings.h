...
/***************************************************
   Station coordinates
***************************************************/
#define CALLSIGN "YOURCALL-13"                     // callsign with SSID ex TK5EP-10
...
byte ALTITUDE = 780;                             // home altitude in meters
...
IPAddress local_IP(00, 000, 00, 000);		  	            // Set your Static IP address like xxx,xxx,xxx,xxx
IPAddress gateway(00, 000, 00, 254);		  	            // Set your Gateway IP address
IPAddress subnet(255, 255, 255, 0);			            // Set your subnet mask
IPAddress primaryDNS(00, 000, 00, 254);		  	         // optional, put 8.8.8.8 if you don't know
...
const char* WG_ID =             "YOURID";                         // Your WunderGround ID. You need to register to get this ID and Key
const char* WG_PWD =            "YOURPWD";                          // Your WunderGround key
...
const char* mqtt_broker =       "yourbrokeraddress";		// the MQTT server
...
/***************************************************
   APRS-IS
***************************************************/
const char *APRS_IS_CALLSIGN =  "YOURCALL-13";					      // APRS IS callsign with SSID, normally -13
...
const char *APRS_IS_SERVER =    "youraprsserver"; // APRS server address
