...
/***************************************************
   OLED display
***************************************************/
byte ECOMODE               = 2;             	   // screensaver 0=OFF 1=PERMANENT 2=ONLY BETWEEN TX
...
const char* TOPIC_TEMP     = "wx/punta/temp";				// topic for the temperature
const char* TOPIC_HUMI     = "wx/punta/humi";				// topic for the humidity
const char* TOPIC_PRESS    = "wx/punta/press";				// topic for the pressure
const char* TOPIC_WINDSPEED= "wx/punta/windspeed";		   // topic for the wind speed
const char* TOPIC_WINDDIR  = "wx/punta/winddir";			// topic for the wind direction
const char* TOPIC_GUSTSPEED= "wx/punta/gustspeed";		   // topic for the wind speed
const char* TOPIC_GUSTDIR  = "wx/punta/gustdir";			// topic for the wind direction
const char* TOPIC_RAIN     = "wx/punta/rain";				// topic for the rain fall
const char* TOPIC_RAIN24H  = "wx/punta/rain24h";			// topic for the 24 h rain fall
const char* TOPIC_WINDSPEEDSENSOR  = "wx/punta/windspeedsensor"; 	   // topic to check if the RS485 dialog is OK
const char* TOPIC_WINDDIRSENSOR  = "wx/punta/winddirsensor"; 	   // topic to check if the RS485 dialog is OK
...
const char *APRS_IS_SERVER    = "aprs-public.radioamateur.corsica"; // APRS server address, ie rotate.aprs.net
...
const char *DSTzone  = "CEST";
int8_t DSTweek       = Last;
int8_t DSTwday       = Sun;
int8_t DSTmonth      = Mar;
int8_t DSTday        = 2;
int8_t DSToffset     = 120;
//ntp.ruleSTD("CET", Last, Sun, Oct, 3, 60); // last sunday in october 3:00, timezone +60min (+1 GMT)
const char *STDzone  = "CEST";
int8_t STDweek       = Last;
int8_t STDwday       = Sun;
int8_t STDmonth      = Mar;
int8_t STDday        = 2;
int8_t STDoffset     = 120;