...
/***************************************************
   Station coordinates
***************************************************/
#define CALLSIGN "TK5EP-14"                     // callsign with SSID ex TK5EP-13
#define LATITUDE "4156.95N"                     // latitude in DDMM.MM NORTH ex : 4156.95N
#define LONGITUDE "00845.26E"                   // longitude in DDDMM.MM EAST ex: 00845.26E
...
#define WG_ID     "IAJACC11"                          // Your WunderGround ID. You need to register to get this ID and Key
#define WG_PWD    "TmbTS4Bz"                          // Your WunderGround key
...
#define TOPIC_TEMP            "wx/qra/temp"			    // topic for the temperature
#define TOPIC_HUMI            "wx/qra/humi"			    // topic for the humidity
#define TOPIC_PRESS           "wx/qra/press"			    // topic for the pressure
#define TOPIC_WINDSPEED       "wx/qra/windspeed"	    // topic for the wind speed
#define TOPIC_WINDDIR         "wx/qra/winddir"		    // topic for the wind direction
#define TOPIC_GUSTSPEED       "wx/qra/gustspeed"	    // topic for the wind speed
#define TOPIC_GUSTDIR         "wx/qra/gustdir"		    // topic for the wind direction
#define TOPIC_RAIN            "wx/qra/rain"			    // topic for the rain fall
#define TOPIC_RAIN24H         "wx/qra/rain24h"		    // topic for the 24 h rain fall
#define TOPIC_WINDSPEEDSENSOR "wx/qra/windspeedsensor" // topic to check if the RS485 dialog is OK
#define TOPIC_WINDDIRSENSOR   "wx/qra/winddirsensor"   // topic to check if the RS485 dialog is OK

/***************************************************
   APRS-IS
***************************************************/
#define APRS_IS_CALLSIGN "TK5EP-14"					      // APRS IS callsign with SSID, normally -13
